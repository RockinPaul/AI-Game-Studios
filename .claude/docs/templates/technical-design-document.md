...
| **APIs Depended On** | [Specific classes/methods/components used, version-pinned — e.g. `CharacterBody3D.move_and_slide() (Godot 4.x)` or `Phaser.Physics.Arcade.Sprite#setVelocity() (Phaser 3.90.0)`] |
| **References Consulted** | [engine-reference docs read before writing this — e.g. `docs/engine-reference/<engine>/modules/physics.md`] |
