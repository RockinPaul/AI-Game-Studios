...
Check:
- **Engine configured?** Read `docs/project/technical-preferences.md`. If it does not exist yet, fall back to `.claude/docs/technical-preferences.md`. If the Engine field contains `[TO BE CONFIGURED]`, the engine is not set.
