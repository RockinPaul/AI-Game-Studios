...
- **engine UI specialist** — Validates UI implementation patterns against engine-specific best practices (read from `docs/project/technical-preferences.md` Engine Specialists → UI Specialist, or `.claude/docs/technical-preferences.md` as a Claude mirror in legacy repos)
...
Before implementation begins, spawn the **engine UI specialist** (from `docs/project/technical-preferences.md` Engine Specialists → UI Specialist, or `.claude/docs/technical-preferences.md` as a Claude mirror in legacy repos) to review the UX spec and visual design spec for engine-specific implementation guidance:
