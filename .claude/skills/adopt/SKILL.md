...
- `docs/project/technical-preferences.md` — engine configured? If it is missing in a legacy Claude-only repo, check `.claude/docs/technical-preferences.md` as the Claude mirror.
...
Read `docs/project/technical-preferences.md`. If it is missing in a legacy Claude-only repo, fall back to `.claude/docs/technical-preferences.md`. Check each field for `[TO BE CONFIGURED]`:
