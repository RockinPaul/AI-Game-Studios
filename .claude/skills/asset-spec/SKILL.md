...
- **Technical preferences**: Read `docs/project/technical-preferences.md` — extract performance budgets and naming conventions. If it is missing in a legacy Claude-only repo, fall back to `.claude/docs/technical-preferences.md`.
