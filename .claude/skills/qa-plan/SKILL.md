...
**Engine**: [engine name from docs/project/technical-preferences.md, or from .claude/docs/technical-preferences.md in legacy Claude-only repos, or "Not configured"]
