...
| Engine-specific patterns or APIs | Primary engine specialist (from `docs/project/technical-preferences.md`, or `.claude/docs/technical-preferences.md` as a Claude mirror in legacy repos) |
