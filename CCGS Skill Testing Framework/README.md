...
├── catalog.yaml           ← master registry: currently 72 skills + 54 agents, coverage tracking
...
│   ├── phaser/            ← Phaser-specific specialists
...
/skill-test static all              # Check all currently registered skills
```
