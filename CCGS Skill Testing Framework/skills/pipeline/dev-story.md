...
- Canonical `docs/project/technical-preferences.md` has engine and language configured, or the `.claude/docs/technical-preferences.md` mirror does
...
- Engine routing logic (Godot vs Unity vs Unreal vs Phaser) is not tested per engine —
