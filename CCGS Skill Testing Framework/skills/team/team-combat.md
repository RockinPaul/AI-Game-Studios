...
- [ ] Phase 2 includes spawning the primary engine specialist (read from canonical `docs/project/technical-preferences.md`, or `.claude/docs/technical-preferences.md` as Claude mirror/fallback)
...
- Engine is configured in canonical `docs/project/technical-preferences.md` (or `.claude/docs/technical-preferences.md` mirror) with the Engine Specialists section filled
...
**Fixture:**
- Canonical `docs/project/technical-preferences.md` has Engine Specialists section populated (or `.claude/docs/technical-preferences.md` mirror), e.g. `Primary: godot-specialist`
...
2. Skill reads the Engine Specialists section from canonical `docs/project/technical-preferences.md` or, if needed, the `.claude/docs/technical-preferences.md` mirror to identify the primary engine specialist agent type
...
**Assertions:**
- [ ] Engine specialist agent type is read from canonical `docs/project/technical-preferences.md` or the `.claude/docs/technical-preferences.md` mirror — not hardcoded
