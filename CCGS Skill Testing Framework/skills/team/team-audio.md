...
- Engine is configured in canonical `docs/project/technical-preferences.md` or the `.claude/docs/technical-preferences.md` mirror
...
**Fixture:**
- Engine is NOT configured in canonical `docs/project/technical-preferences.md` or the `.claude/docs/technical-preferences.md` mirror (shows `[TO BE CONFIGURED]`)
- GDD for the target feature exists
...
**Expected behavior:**
1. Context gathering: orchestrator reads canonical `docs/project/technical-preferences.md` or the `.claude/docs/technical-preferences.md` mirror and detects no engine is configured
