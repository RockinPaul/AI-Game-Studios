...
Related skills: ../graphics-and-shapes/SKILL.md, ../physics-arcade/SKILL.md
...
Geometry objects are pure data containers holding coordinates and dimensions. They are NOT game objects and cannot be added to the display list. To render geometry, use the Graphics game object or Shape game objects (see ../graphics-and-shapes/SKILL.md).
